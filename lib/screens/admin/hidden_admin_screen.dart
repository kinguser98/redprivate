...
class _HiddenAdminScreenState extends State<HiddenAdminScreen> {
  ...
  // ⚡ Extractor Cinema (Ad-Free Player) State
  int _cinemaSource = 0; // 0: UFFMaal, 1: HDMaal, 2: AAGMaal, 3: UncutMasti, 4: HDMove99, 5: SkyMoviesHD
  List<Map<String, dynamic>> _cinemaCatalog = [];
  bool _cinemaLoading = false;
  int _cinemaPage = 1;
  bool _cinemaLandscape = true;
  final _cinemaSearchCtrl = TextEditingController();
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // ⚡ Live Extractor Cinema Feature Banner
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(
                  colors: [Color(0xFF0D251C), Color(0xFF00C853)],
                  begin: Alignment.topLeft,
                  end: Alignment.bottomRight,
                ),
                borderRadius: BorderRadius.circular(16),
                border: Border.all(color: const Color(0xFF69F0AE).withOpacity(0.6), width: 1.2),
                boxShadow: [
                  BoxShadow(color: const Color(0xFF00E676).withOpacity(0.25), blurRadius: 14, offset: const Offset(0, 4)),
                ],
              ),
              child: Row(
                children: [
                  ...
                  const Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("⚡ LIVE EXTRACTOR CINEMA", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 15, letterSpacing: 0.8)),
                        SizedBox(height: 3),
                        Text("Browse UffMaal, HDMaal, Uncut, AAGMaal, HDMove99 & watch ad-free in native player!", style: TextStyle(color: Colors.white70, fontSize: 11.5)),
                      ],
                    ),
                  ),
                  const Icon(Icons.play_circle_fill_rounded, color: Colors.amberAccent, size: 30),
                ],
              ),
            ),
          ),
